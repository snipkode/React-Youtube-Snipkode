...
export default class AddData extends Component {
	...
	addData = () =>{
		// [{id:1, nama:'Magnet Rezeki', author: 'Nasrullah', harga: 12000, publish: true},
		...
		const data = {id:4, nama:'Gizi Ramadhan', author: 'KH. Abdullah Gymnastiar', harga: 50000, publish: false};
		db.ref('/buku').push(data);
	}
	render() {
		return (
			<div>
